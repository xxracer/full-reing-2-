              ...
              <div className="program-image-wrapper">
                <img
                  ...
                  style={{
                    ...
                    height: '100%',
                    objectFit: 'cover',
                    // Use object-position with percentages. Default to 50% 50% (Center) if undefined.
                    // We expect coords to be numbers (0-100) representing percentages.
                    objectPosition: `${program.coords?.x ?? 50}% ${program.coords?.y ?? 50}%`,
                    transform: `scale(${program.zoom || 1})`,
                    transformOrigin: `${program.coords?.x ?? 50}% ${program.coords?.y ?? 50}%`, // Zoom from the focal point
